...
public class VelocityUtils {
    ...
    /** 数据库项目路径 */
    private static final String REPOSITORY_PATH = "/bahar-repository/src/main";

    /** mapper路径 */
    private static final String MAPPER_PATH = "/java/com/bahar/repository/mapper";

    /** model路径 */
    private static final String MODEL_PATH = "/java/com/bahar/repository/model";

    /** mybatis xml路径 */
    private static final String MAPPER_XML_PATH = "/resources/mapper";

    /** 接口服务路径 */
    private static final String SERVICE_PATH = "/bahar-application/src/main/java/com/bahar/common/service";

    /** 控制器路径 */
    private static final String CONTROLLER_PATH = "/bahar-application/src/main/java/com/bahar/module/backendApi/controller";
