        ...
        <view class="contacts">
          ...
          <view class="value">
             <radio-group @change="genderChange">
                <label class="radio"><radio value="1" color="#6d64c5" :checked="userInfo.sex == '1' ? true : false"/>男</label>
                <label class="radio second"><radio value="0" color="#6d64c5" :checked="userInfo.sex == '0' ? true: false"/>女</label>
             </radio-group>
          </view>
        </view>
      </view>
